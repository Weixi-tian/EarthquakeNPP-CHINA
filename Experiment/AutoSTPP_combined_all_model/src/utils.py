...
def scale_ll_all_events_new(dataloader, magnitude_inforamtion, nll, sll, tll, sll_all, tll_all, scales=None):
    """
    ...
    """
    if magnitude_inforamtion == False:
    ...
    elif magnitude_inforamtion == True:
        if dataloader is not None:
        ...
        # print('scales是',s0_scale, s1_scale, m_scale, t_scale)
        t_scale = np.log(t_scale)
        s_scale = np.log(s0_scale * s1_scale)
