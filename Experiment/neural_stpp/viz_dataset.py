...
def load_data(data, split="train"):
    ...
    if data == "citibike":
        ...
        return datasets.Custom_Earthquakes(data,window = 7.332638888888889,split=split)
    elif data == "CENC_20":
        return datasets.Custom_Earthquakes(data,window = 7.332638888888889,split=split)
    elif data == "CENC_25":
        return datasets.Custom_Earthquakes(data,window = 8.440277777777778,split=split)
    elif data == "CENC_30":
        return datasets.Custom_Earthquakes(data,window = 23.986805555555556,split=split)
    elif data == "CENC_35":
        return datasets.Custom_Earthquakes(data,window = 53.05637731481482,split=split)
    else:
